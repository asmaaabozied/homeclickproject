        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.offers.update', $offer->id) }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control select2" name="product_id" id="parent" required>
                                    ...
                                    @foreach($products as $id => $item)
                                        <option value="{{$id}}"   @if($offer->product_id ==$id) selected @endif  >{{$item}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" name="start_at" class="form-control date"  value="{{$offer->start_at}}" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" name="end_at" class="form-control date" value="{{$offer->end_at}}"  required>
