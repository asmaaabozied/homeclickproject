...
return [
    ...
    */
    ...
    'regex' => '  كلمة المرور مكونة من 8 أحرف على الأقل بما في ذلك أحرف صغيرة وحرف كبير ورقم وحرف خاص واحد (! @ $٪  صيغة :attribute .غير صحيح .',
    ...
    */
    ...
    'attributes' => [
        ...
        'rate'=>'التقيم',
        'store_id'=>'التاجر',
        'subscribe_id'=>'رقم الاشتراك',
        'old_name'=>'الاسم القديم',
        'new_name'=>'الاسم الجديد',
        'product_id'=>'المنتح',
        'country_id'=>'المدينه',
        'lastname'=>'الاسم الاول ',
        'firstname'=>'الاسم الاخير',
        'location'=>'المؤقع',
        'device_id'=>'رقم الجهاز',
        'lawercase_id'=>'رقم القضيه',
        'firebase_token'=>'رمز',
        'typeconslution_id'=>'نوع الاستشاره',
        'details'=>'تفاصيل ',
        'catogeryjob_id'=>'الوظيفه',
        'instegram'=>'الانستجزام',
        'facebook'=>'الفيس بوك',
        'twitter'=>'التويتر',
        'token'=>'رمز',
        'images'=>'الملف',
